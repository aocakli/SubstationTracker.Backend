...
namespace SubstationTracker.Persistence.Migrations
{
    ...
    [Migration("20230520235801_AddedSubstationMovementTableAndSomeColumnEditedFromInventory")]
    partial class AddedSubstationMovementTableAndSomeColumnEditedFromInventory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SubstationTracker.Domain.Concrete.Substations.OtherDomains.SubstationMovements.OtherDomains.Inventories.Inventory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid>("SubstationMovementId")
                        .HasColumnType("uuid")
                        .HasColumnOrder(2);
                    ...
                    b.HasIndex("SubstationMovementId")
                        .IsUnique();

                    b.ToTable("Inventories");
                });

            modelBuilder.Entity("SubstationTracker.Domain.Concrete.Substations.OtherDomains.SubstationMovements.OtherDomains.Inventories.InventoryEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnOrder(0);
            ...
            modelBuilder.Entity("SubstationTracker.Domain.Concrete.Substations.OtherDomains.SubstationMovements.OtherDomains.Inventories.InventoryOut", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnOrder(0);
            ...
            modelBuilder.Entity("SubstationTracker.Domain.Concrete.Substations.OtherDomains.SubstationMovements.SubstationMovement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("SubstationTracker.Domain.Concrete.Substations.OtherDomains.SubstationMovements.OtherDomains.Inventories.Inventory", b =>
                {
                    b.HasOne("SubstationTracker.Domain.Abstractions.Audits.Audit", "Audit")
                        .WithOne("Inventory")
                        .HasForeignKey("SubstationTracker.Domain.Concrete.Substations.OtherDomains.SubstationMovements.OtherDomains.Inventories.Inventory", "AuditId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("SubstationTracker.Domain.Concrete.Substations.OtherDomains.SubstationMovements.SubstationMovement", "SubstationMovement")
                        .WithOne("Inventory")
                        .HasForeignKey("SubstationTracker.Domain.Concrete.Substations.OtherDomains.SubstationMovements.OtherDomains.Inventories.Inventory", "SubstationMovementId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("SubstationMovement");
                });
            ...
            modelBuilder.Entity("SubstationTracker.Domain.Concrete.Substations.OtherDomains.SubstationMovements.OtherDomains.Inventories.InventoryEntry", b =>
                {
                    b.HasOne("SubstationTracker.Domain.Abstractions.Audits.Audit", "Audit")
                        ...
                        .HasForeignKey("SubstationTracker.Domain.Concrete.Substations.OtherDomains.SubstationMovements.OtherDomains.Inventories.InventoryEntry", "AuditId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SubstationTracker.Domain.Concrete.Substations.OtherDomains.SubstationMovements.OtherDomains.Inventories.Inventory", "Inventory")
                        .WithOne("InventoryEntry")
                        .HasForeignKey("SubstationTracker.Domain.Concrete.Substations.OtherDomains.SubstationMovements.OtherDomains.Inventories.InventoryEntry", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SubstationTracker.Domain.Concrete.Substations.OtherDomains.SubstationMovements.OtherDomains.Inventories.InventoryOut", b =>
                {
                    b.HasOne("SubstationTracker.Domain.Abstractions.Audits.Audit", "Audit")
                        ...
                        .HasForeignKey("SubstationTracker.Domain.Concrete.Substations.OtherDomains.SubstationMovements.OtherDomains.Inventories.InventoryOut", "AuditId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SubstationTracker.Domain.Concrete.Substations.OtherDomains.SubstationMovements.OtherDomains.Inventories.Inventory", "Inventory")
                        .WithOne("InventoryOut")
                        .HasForeignKey("SubstationTracker.Domain.Concrete.Substations.OtherDomains.SubstationMovements.OtherDomains.Inventories.InventoryOut", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SubstationTracker.Domain.Concrete.Substations.OtherDomains.SubstationMovements.SubstationMovement", b =>
                {
                    b.HasOne("SubstationTracker.Domain.Abstractions.Audits.Audit", "Audit")
                        .WithOne("SubstationMovement")
                        .HasForeignKey("SubstationTracker.Domain.Concrete.Substations.OtherDomains.SubstationMovements.SubstationMovement", "AuditId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SubstationTracker.Domain.Concrete.Substations._Bases.Substation", "Substation")
                        .WithMany("SubstationMovements")
            ...
            modelBuilder.Entity("SubstationTracker.Domain.Concrete.Substations._Bases.Substation", b =>
                {
                    b.Navigation("SubstationMovements");
